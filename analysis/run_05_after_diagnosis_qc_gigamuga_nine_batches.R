...
job.name <- "05_after_diagnosis_qc_gigamuga_nine_batches"
...
write("#PBS -l nodes=1:ppn=20,walltime=00:20:00:00", script.file, append =T)
...
write("module load pandoc", script.file, append = T)
