...
```{r plot scan result for m1 Novelty_residuals_RankNormal_datarelease_12182019, fig.height=14, fig.width=14, eval=F}
print("m1")
...
```{r plot scan result for m3 Novelty_residuals_RankNormal_datarelease_12182019, fig.height=14, fig.width=14, eval=F}
print("m3")
