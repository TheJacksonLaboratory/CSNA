---
title: "plot_qtl_mapping_Novelty_residuals_RankNormal_datarelease_12182019"
author: "Hao He"
date: "`r Sys.Date()`"
...
```{r plot scan result for m1 Novelty_residuals_RankNormal_datarelease_12182019, fig.height=14, fig.width=14, eval=FALSE}
print("m1")
...
```{r plot scan result for m2 Novelty_residuals_RankNormal_datarelease_12182019,fig.height=14, fig.width=14, eval=TRUE}
print("m2")
...
for(i in names(m2.qtl.out)){
  ...
  plot(m2.qtl.out[[i]], gm_DO2816_qc$gmap, lodcolumn=1,
       col="slateblue", ylim=c(0, cutoff[2]*1.2),
       main=i)
  abline(h=cutoff[1], col="red",lty=2) # 0.05 cutoff
  abline(h=cutoff[2], col="red",lty=1) # 0.1 cutoff
}
...
```{r plot scan result for m3 Novelty_residuals_RankNormal_datarelease_12182019, fig.height=14, fig.width=14, eval=FALSE}
print("m3")
