...
```{r DO phenos and correlation, warning = FALSE, eval = FALSE}
...
if(FALSE){# it's done in the cluster
...
```{r Phenotypes for QTL, warning = FALSE, eval = FALSE}
